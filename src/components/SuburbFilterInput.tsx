 ...
 */
export default function SuburbFilterInput({ defaultValue = "" }: SuburbFilterInputProps) {
    ...
    <form onSubmit={handleSubmit} className="flex gap-2">
      <div className="relative flex-1">
        <input
          ...
          placeholder="e.g. Brisbane, Parramatta, Subiaco"
      ...
      <button
        type="submit"
        className="rounded-full bg-teal-500 px-4 py-2.5 text-sm font-semibold text-slate-950 transition hover:bg-teal-400"
      >
        Search
      </button>
    </form>
